...
export class SimulationEngine {
    ...
    public tick(components: CircuitComponent[], wires: WireSegment[], dt: number) {
        ...
        components.forEach(comp => {
            ...
            if (comp.type === 'resistor' || comp.type === 'bulb' || comp.type === 'led' || comp.type === 'motor' || comp.type === 'buzzer' || comp.type === 'potentiometer' || comp.type === 'diode' || comp.type === 'ammeter' || comp.type === 'voltmeter' || comp.type === 'fuse') {
        ...
        components.forEach(comp => {
            ...
            if (comp.type === 'battery') {
                ...
                current = x[n + bIdx];
            } else if (comp.type === 'resistor' || comp.type === 'bulb' || comp.type === 'led' || comp.type === 'motor' || comp.type === 'buzzer' || comp.type === 'potentiometer' || comp.type === 'diode' || comp.type === 'ammeter' || comp.type === 'voltmeter' || comp.type === 'fuse') {
